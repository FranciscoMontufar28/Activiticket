...
public class GameOverDespRActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_over_desp_r);
        gameover = (ImageView) findViewById(R.id.gameoverdespr);
